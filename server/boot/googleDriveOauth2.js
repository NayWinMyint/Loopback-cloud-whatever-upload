...
module.exports = function(app) {
  ...
  var TOKEN_DIR = './';
  var TOKEN_PATH = TOKEN_DIR + 'drive-netsong-token.json';
  ...
  function setOauth2Client(oauth2Client) {
    google.options({
      auth: oauth2Client
    });
  }
